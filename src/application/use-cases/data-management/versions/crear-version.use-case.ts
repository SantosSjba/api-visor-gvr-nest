...
export class CrearVersionUseCase {
    ...
    async execute(userId: number, projectId: string, dto: CrearVersionDto): Promise<any> {
        ...
        return await this.autodeskApiService.crearVersion(token.tokenAcceso, projectId, dto.data);
    }
}
