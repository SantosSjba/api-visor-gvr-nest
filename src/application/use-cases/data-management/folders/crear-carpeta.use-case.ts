...
export class CrearCarpetaUseCase {
    ...
    async execute(userId: number, projectId: string, dto: CrearCarpetaDto): Promise<any> {
        ...
        return await this.autodeskApiService.crearCarpeta(token.tokenAcceso, projectId, dto.data);
    }
}
