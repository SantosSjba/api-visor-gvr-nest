...
export class ActualizarCarpetaUseCase {
    ...
    async execute(userId: number, projectId: string, folderId: string, dto: ActualizarCarpetaDto): Promise<any> {
        ...
        return await this.autodeskApiService.actualizarCarpeta(token.tokenAcceso, projectId, folderId, dto.data);
    }
}
