...
export class EliminarCarpetaUseCase {
    ...
    async execute(userId: number, projectId: string, folderId: string): Promise<any> {
        ...
        return await this.autodeskApiService.eliminarCarpeta(token.tokenAcceso, projectId, folderId);
    }
}
